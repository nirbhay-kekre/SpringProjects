...
public class SecretServiceImpl implements SecretService {
	...
	/* (non-Javadoc)
	 * @see edu.sjsu.cmpe275.aop.SecretService#createSecret(java.lang.String, java.lang.String)
	 * invalid if userid = null
	 * secretContent > 100 throw illegal argument
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.sjsu.cmpe275.aop.SecretService#readSecret(java.lang.String, java.util.UUID)
	 * if any argument is null throw exception
	 */
	@Override
